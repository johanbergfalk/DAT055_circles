...
public class CircleDetailsPanel extends JPanel {
    ...
    Movie movie1 = new Movie("film1", 1, "description", 1997, "url");
    Movie movie2 = new Movie("film2", 2, "description", 2004, "url");
    Movie movie3 = new Movie("film2", 3, "description", 2015, "url");
